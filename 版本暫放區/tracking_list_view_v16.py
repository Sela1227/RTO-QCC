    ...
    def build(self) -> ft.Control:
        ...
        if treatments:
            ...
            for i in range(0, len(cards), 4):
                ...
                card_rows.append(ft.Row(controls=row_cards, spacing=8))
    ...
    def _build_card(self, treatment) -> ft.Control:
        ...
        return ft.Container(
            ...
            content=ft.Column([
                # 行1：病歷號 姓名
                ft.Row([
                    ft.Text(medical_id, size=10, weight=ft.FontWeight.BOLD, color=SELATheme.TEXT_PRIMARY),
                    ft.Text(name, size=10, max_lines=1, overflow=ft.TextOverflow.ELLIPSIS),
                ], spacing=4),
                # 行2：癌別 年紀
                ft.Row([
                    ft.Text(cancer, size=10, color=SELATheme.TEXT_SECONDARY),
                    ft.Container(expand=True),
                    ft.Text(age, size=10, color=SELATheme.TEXT_HINT),
                ], spacing=2),
                # 行3：體重 天數 %
                ft.Row([
                    ft.Text(current_weight, size=10, color=SELATheme.TEXT_SECONDARY),
                    ft.Container(expand=True),
            ...
            chart_section = ft.Container(
                ...
                content=ft.Stack([
                    ...
                    ft.Container(
                        ...
                        padding=4,
                        content=ft.Icon(ft.Icons.FULLSCREEN, size=16, color=SELATheme.TEXT_HINT),
                    ),
                ]),
            )
