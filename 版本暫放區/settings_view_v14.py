        ...
        return ft.Container(
            ...
            content=ft.Row([
                ft.Column([
                    ...
                    ft.Text(subtitle, size=13, color=SELATheme.TEXT_HINT),
                ], spacing=2, expand=True),
                ft.Text(value, size=15, color=SELATheme.PRIMARY, weight=ft.FontWeight.BOLD),
                ft.Icon(ft.Icons.CHEVRON_RIGHT, size=18, color=SELATheme.TEXT_HINT) if on_tap else ft.Container(),
            ]),
        )
