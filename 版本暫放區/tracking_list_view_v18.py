...
class TrackingListView:
    ...
    def _update_detail(self, treatment):
        ...
        if len(records) >= 2:
            ...
            # 使用 GestureDetector 確保點擊有效
            chart_section = ft.GestureDetector(
                on_tap=lambda e: self._show_chart_fullscreen(treatment, records),
                    ...
                    content=ft.Stack([
                        ...
                        ft.Container(
                            ...
                            content=ft.Container(
                                ...
                                border_radius=4,
                                padding=4,
                                content=ft.Icon(ft.Icons.FULLSCREEN, size=20, color=SELATheme.PRIMARY),
                            ),
                        ),
                    ]),
                ),
